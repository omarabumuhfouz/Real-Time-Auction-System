...
public static class GetProfile
{
    public static void MapEndpoint(IEndpointRouteBuilder app)
    {
        ...
        .WithDescription("Fetches detailed profile information for a specific bidder using their unique identifier. Returns a 404 if the bidder does not exist. **Requires authentication (any role).**")
