...
/**
 * OrderRowsSkeleton Component
 * 
 * Renders a set of animated ghost placeholder rows matching the exact geometry 
 * of OrderActivityItem component. Used to optimize layout shifting and perceived performance 
 * during async fetch operations.
 */
      ...
      {Array.from({ length: 3 }).map((_, idx) => (
        ...
        >
          ...
          <div className="flex justify-end w-full md:w-auto shrink-0">
            <div className="w-48 h-14 bg-gray-200 rounded-xl" />
          </div>
        </div>
      ))}
    </div>
