...
// public class TesseractIdentityExtractionService
// {
...
//         {
//             return new ExtractedIdData(null, false,
//                 $"OCR Engine failure: tessdata directory not found at '{tessdataDir}'. " +
//                 "Ensure ara.traineddata and eng.traineddata are placed in a 'tessdata' folder next to the application executable.");
//         }
...
//         catch (Exception ex)
//         {
//             // Unwrap TargetInvocationException to surface the real root cause
//             var rootCause = ex;
...
//                 ? ex.Message
//                 : $"{ex.Message} → Root cause: [{rootCause.GetType().Name}] {rootCause.Message}";

//             return new ExtractedIdData(null, false, $"OCR Engine failure: {fullMessage}");
//         }
